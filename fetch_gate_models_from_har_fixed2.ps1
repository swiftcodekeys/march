...
# fetch_gate_models_from_har_fixed2.ps1
# Uses PowerShell call operator with argument array so curl receives UA/headers correctly.
...
if ($failures.Count -gt 0) {
  ...
  Write-Host ""
  throw "Some files failed to download. Stay on the hotspot network that returned HTTP 200 and rerun."
}
